...
def ask_gpt_contrary(assumption, proposition):
    ...
    Example 0:
    - Phrase A (Assumption): "no_evident_not_helpful_staff"
    - Phrase B (Proposition): "staff_not_speak_English_properly"
    - Answer: False (not contrary - non-English-speaking staff can be helpful in other ways)

    Example 1:
    - Phrase A (Assumption): "no_evident_not_helpful_staff"
    - Phrase B (Proposition): "not_kind_staff"
    - Answer: True (contrary - not-kind staff will not be helpful)
    
    Example 2:
    - Phrase A (Assumption): "no_evident_not_helpful_staff"
    - Phrase B (Proposition): "no_staff_at_night"
    - Answer: False (not contrary - it is possible to happen that there is no staff at night but the stuff are helpful in the day)
    
    Example 3:
    - Phrase A (Assumption): "no_evident_not_good_front_service_at_night"
    - Phrase B (Proposition): "no_staff_at_night"
    - Answer: True (contrary : good front service at night and no staff at night are contradictory)
    
    Example 4:
    - Phrase A (Assumption): "no_evident_not_accomodating_staff"
    - Phrase B (Proposition): "friendly_staff"
    - Answer: True (contrary - accommodating staff and friendly staff are contradictory)
